...
export const ADMIN_CREDENTIALS = {
  email: "kanzaaffa@gmail.com",
  password: "SariRoti1286",
};
...
export const SUPABASE_CONFIG = {
  ...
  edgeFunctionGuestbook:
    "https://liyfsapgadickknsfbus.functions.supabase.co/rate-limit-guestbook",
  edgeFunctionCheckin:
    "https://liyfsapgadickknsfbus.functions.supabase.co/check-in",
} as const;
